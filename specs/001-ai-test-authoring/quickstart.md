...
| Concurrency | never more jobs in flight than configured, except a case whose targets exceed the limit — a known limitation, warned about at validation (SC-011) |
