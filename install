#!/bin/sh
set -e
# Original code generated by godownloader on 2021-08-16T21:37:49Z.
# Due to deprecation of godownloader, this file has been modified by hand thereafter.
#
...
get_binaries() {
  case "$PLATFORM" in
    darwin/386) BINARIES="saucectl" ;;
    darwin/amd64) BINARIES="saucectl" ;;
    darwin/arm64) BINARIES="saucectl" ;;
    linux/386) BINARIES="saucectl" ;;
    linux/arm64) BINARIES="saucectl" ;;
    linux/amd64) BINARIES="saucectl" ;;
    windows/386) BINARIES="saucectl" ;;
    windows/amd64) BINARIES="saucectl" ;;
    *)
...
https://github.com/saucelabs/saucectl/blob/master/LICENSE.md
