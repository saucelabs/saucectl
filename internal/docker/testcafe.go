...
func NewTestcafe(c testcafe.Project, ms framework.MetadataService, wr job.Writer, dl download.ArtifactDownloader, reps []report.Reporter) (*TestcafeRunner, error) {
	r := TestcafeRunner{
		Project: c,
