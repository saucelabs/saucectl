...
func TestClient_ReadJob(t *testing.T) {
	...
	for _, tt := range testCases {
		job, err := client.ReadJob(context.Background(), tt.jobID, false)
...
func TestClient_GetJobAssetFileNames(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			files, err := client.GetJobAssetFileNames(context.Background(), tt.jobID, false)
			if err != nil {
...
func TestClient_GetJobAssetFileContent(t *testing.T) {
	...
	for _, tt := range testCases {
		data, err := client.GetJobAssetFileContent(context.Background(), tt.jobID, tt.fileName, false)
		assert.Equal(t, err, tt.wantErr)
		if err == nil {
