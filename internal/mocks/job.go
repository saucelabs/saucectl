...
type FakeJobReader struct {
	...
	PollJobFn                func(ctx context.Context, id string, interval time.Duration, timeout time.Duration) (job.Job, bool, error)
...
func (fjr *FakeJobReader) PollJob(ctx context.Context, id string, interval time.Duration, timeout time.Duration) (job.Job, bool, error) {
