...
const (
	// NpmEmptyScope indicates a missing scope value
	NpmEmptyScope = "scope of scoped registry %d is empty"
	// NpmEmptyURL indicates a missing URL value
	NpmEmptyURL = "url of scoped registry %d is empty"
)
