...
func NewEspressoCmd() *cobra.Command {
	...
	sc.Bool("audioCapture", "suite::overwriteDeviceSettings::audioCapture", false, "Overwrite settings for real device to capture audio.")
	sc.Bool("networkCapture", "suite::overwriteDeviceSettings::instrumentation::networkCapture", false, "Overwrite settings for real device to capture network.")
